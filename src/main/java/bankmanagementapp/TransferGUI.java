            ...
            try {
                if (amountField.getText().trim().isEmpty()) {
                    JOptionPane.showMessageDialog(this,
                        "Amount field cannot be empty.", "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                if (recipient.isEmpty()) {
                    JOptionPane.showMessageDialog(this,
                        "Please enter recipient account number.", "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }

                // ← KEY CHANGE: use transferMoney() so recipient's balance is credited too
                String result = manager.transferMoney(amount, dateField.getText(), recipient);
                ...
                if (result.equals("SUCCESS")) {
                    ...
                    JOptionPane.showMessageDialog(this,
                        ...
                        + "\nRemaining Balance: PHP " + String.format("%,.2f", manager.getBalance()),
                    ...
                    JOptionPane.showMessageDialog(this,
                        result, "Transfer Error", JOptionPane.ERROR_MESSAGE);
                    amountField.setText("");
