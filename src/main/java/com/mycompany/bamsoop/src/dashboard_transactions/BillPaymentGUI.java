...
public class BillPaymentGUI extends JFrame {
    ...
    public BillPaymentGUI(TransactionManager manager,
        ...
        JLabel bankLBL = new JLabel("STATE BANK • BILL PAYMENT");
        ...
        currentBalanceLBL.setFont(new Font("Tahoma", Font.BOLD, 13));
        ...
        JLabel detailsLBL = new JLabel("BILL PAYMENT DETAILS");
        ...
        detailsLBL.setFont(new Font("Tahoma", Font.BOLD, 14));
        card.add(detailsLBL);
        ...
        billLBL.setFont(new Font("Tahoma", Font.BOLD, 13));
        card.add(billLBL);
        ...
        billTypeCombo.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(new Color(220, 225, 235), 1),BorderFactory.createEmptyBorder(0, 10, 0, 10)));
        ...
        accountLBL.setFont(new Font("Tahoma", Font.BOLD, 13));
        card.add(accountLBL);
        ...
        accountField.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(new Color(220, 225, 235), 1),BorderFactory.createEmptyBorder(0, 15, 0, 15)));
        ...
        JLabel noteLBL = new JLabel("Payments are processed instantly");
        ...
        payBTN.setBackground(new Color(18, 45, 105));
        ...
        //ACTION LISTENERS 
        dashboardBTN.addActionListener(e -> {mainWindow.setVisible(true);
            dispose();
        });
        ...
        payBTN.addActionListener(e -> {
            try {
                ...
                {JOptionPane.showMessageDialog(this, "Account number cannot be empty.","Error",JOptionPane.ERROR_MESSAGE); accountField.setText("");
                    return;
                }
                if (amountField.getText().trim().isEmpty()) {
                    JOptionPane.showMessageDialog(this,"Amount field cannot be empty.","Error",JOptionPane.ERROR_MESSAGE);amountField.setText("");
                    return;
                }
                double amount = Double.parseDouble(amountField.getText().trim());

                if (amount <= 0) {
                    JOptionPane.showMessageDialog(this,"Amount must be greater than 0.","Error",JOptionPane.ERROR_MESSAGE); amountField.setText("");
                    return;
                }
                ...
                String result = manager.addTransaction("Bills Payment", amount, java.time.LocalDate.now().toString(), biller);
