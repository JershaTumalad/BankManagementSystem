...
heroCard.add(sep);
        ...
        ImageIcon addLoginIcon = loadImage("/images/login_icon.png", 70, 70);
        JLabel addImage = new JLabel(addLoginIcon);
        addImage.setBounds(20, 220, 70, 70);
        heroCard.add(addImage);
        ...
        ImageIcon addForgotIcon = loadImage("/images/forgot_icon.png", 70, 70);
        JLabel addImage2 = new JLabel (addForgotIcon);
        addImage2.setBounds(20, 290, 70, 70);
        heroCard.add(addImage2);
          ...
          this.dispose();
            ...
            ImageIcon addCreateIcon = loadImage("/images/create_icon.png", 70, 70);
        JLabel addImage3 = new JLabel (addCreateIcon);
        addImage3.setBounds(20, 360, 70, 70);
        heroCard.add(addImage3);
