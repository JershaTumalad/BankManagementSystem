...
public class searchPage extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (acc != null) {
            ...
            lblName.setText("Name: " + acc.name) ;
            lblaccType.setText("Account Type: " + acc.accountType);
            lblResultAccNo.setText("Account No.: " + acc.accountNo) ;
            lbliniBal.setText("Balance: " + acc.balance);
        } else {
